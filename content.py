...
abs101 = """Deine VITALITÄT ist normal. Trage dies nun auf dem Abenteuerblatt ein.
...
abs292 = """Das Gitter zeigt deutliche Rostflecken, macht dennoch einen robusten Eindruck. Ohne nachzudenken packst du eine der Querstangen und rüttelst. Fest.
...
abs271 = """Du atmest tief ein und konzentrierst dich auf die Kraft deines Körpers. Dann zerrst du mit einem vor Anstrengung unterdrückten Schrei am Gitter."""

abs256 = """Du fokusierst deine wahrhaft übermenschliche Kraft über deine Klauen auf das Metall. Beim dritten Ruck rieselt feiner Steinstaub an der Verankerung, bis schließlich Steine zu Boden poltern. Das Gitter liegt fre! Übereilte Schritte dringen in dein Ohr."""

absK1 = """Alsbald verpestet der typische Gestank eines Gartak die Luft. Die gedrungenen, stark behaarten Wesen sind eine dumpfe Kriegerrasse, gezüchtet in den Katakomben der Magierstadt Tul-Sar-Mar. Bedingungslos dienen sie ihren Echsenmeistern.
...
absK8 = """Die schwarzen Augen im wildschweinartigen Schädel des Gartak weiten sich, als du ihn zu einem offenen Zweikampf zwingst. Mach dich bereit zum Angriff auf den Gefängniswärter!"""
...
zweiter_prototyp_pfad = {
    ...
    "absK1": {
        ...
        "text_options": {
            "1": "dem Gegner Gartak entgegenstellen?"
        }
    },
    "absK8": {
        "content": absK8,
        ...
        "kampfSek": True,
        "gegner": Gegner.Gegner("GARTAK, GEFÄNGNISWÄRTER", 2, 11, 10)
    }
}